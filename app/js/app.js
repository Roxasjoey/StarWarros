...
App.controller('InsertCtrl', function($scope, $rootScope, $log, $http, $routeParams, $location, $route) {
  ...
  $scope.submitInsert = function() {
    var guest = {
      TIPODEPERSONAJE : $scope.TIPODEPERSONAJE,
      nombredepersonaje : $scope.nombredepersonaje,
      nombredejugador : $scope.nombredejugador,
      Altura : $scope.Altura,
      peso : $scope.peso,
      Sexo :    $scope.Sexo,
      Edad :    $scope.Edad,
      descripcionfisica :    $scope.descripcionfisica
